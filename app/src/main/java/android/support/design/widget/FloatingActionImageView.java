 ...
 */
@CoordinatorLayout.DefaultBehavior(FloatingActionImageView.Behavior.class)
public class FloatingActionImageView extends VisibilityAwareImageButton {
    ...
    public abstract static class OnVisibilityChangedListener {
         ...
         */
        public void onShown(FloatingActionImageView fab) {}
         ...
         */
        public void onHidden(FloatingActionImageView fab) {}
    }
    ...
    private InternalVisibilityChangedListener wrapOnVisibilityChangedListener(
        ...
        return new InternalVisibilityChangedListener() {
            @Override
            public void onShown() {
                listener.onShown(FloatingActionImageView.this);
            }

            @Override
            public void onHidden() {
                listener.onHidden(FloatingActionImageView.this);
            }
        };
    }
    ...
    /**
     * Behavior designed for use with {@link FloatingActionImageView} instances. Its main function
     * is to move {@link FloatingActionImageView} views so that any displayed {@link Snackbar}s do
     * not cover them.
     */
    public static class Behavior extends CoordinatorLayout.Behavior<FloatingActionImageView> {
        ...
        private boolean shouldUpdateVisibility(View dependency, FloatingActionImageView child) {
        ...
        private boolean updateFabVisibilityForAppBarLayout(CoordinatorLayout parent,
                                                           AppBarLayout appBarLayout, FloatingActionImageView child) {
        ...
        @Override
        public boolean onLayoutChild(CoordinatorLayout parent, FloatingActionImageView child,
                                     int layoutDirection) {
        ...
        public boolean getInsetDodgeRect(@NonNull CoordinatorLayout parent,
                                         @NonNull FloatingActionImageView child, @NonNull Rect rect) {
         ...
         * our parent's edges.
         */
        private void offsetIfNeeded(CoordinatorLayout parent, FloatingActionImageView fab) {
...
//                    right + mImagePadding, bottom + mImagePadding);
        ...
        public void setBackgroundDrawable(Drawable background) {
            FloatingActionImageView.super.setBackgroundDrawable(background);
        }
