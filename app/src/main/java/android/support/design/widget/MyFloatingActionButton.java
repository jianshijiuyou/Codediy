...
import android.support.design.widget.MyFloatingActionButtonImpl.InternalVisibilityChangedListener;
 ...
 */
@CoordinatorLayout.DefaultBehavior(MyFloatingActionButton.Behavior.class)
public class MyFloatingActionButton extends VisibilityAwareImageButton {

    private static final String LOG_TAG = "MyFloatingActionButton";

    /**
     * Callback to be invoked when the visibility of a MyFloatingActionButton changes.
     */
    public abstract static class OnVisibilityChangedListener {
        /**
         * Called when a MyFloatingActionButton has been
         * {@link #show(OnVisibilityChangedListener) shown}.
         *
         * @param fab the MyFloatingActionButton that was shown.
         */
        public void onShown(MyFloatingActionButton fab) {}

        /**
         * Called when a MyFloatingActionButton has been
         * {@link #hide(OnVisibilityChangedListener) hidden}.
         *
         * @param fab the MyFloatingActionButton that was hidden.
         */
        public void onHidden(MyFloatingActionButton fab) {}
    }
    ...
    private MyFloatingActionButtonImpl mImpl;
     ...
     * @attr ref android.support.design.R.styleable#MyFloatingActionButton_rippleColor
     * @see #getRippleColor()
     */
    ...
    /**
     * Set whether MyFloatingActionButton should add inner padding on platforms Lollipop and after,
     * to ensure consistent dimensions on all platforms.
     *
     * @param useCompatPadding true if MyFloatingActionButton is adding inner padding on platforms
     *                         Lollipop and after, to ensure consistent dimensions on all platforms.
     *
     * @attr ref android.support.design.R.styleable#MyFloatingActionButton_useCompatPadding
    ...
    /**
     * Returns whether MyFloatingActionButton will add inner padding on platforms Lollipop and after.
     *
     * @return true if MyFloatingActionButton is adding inner padding on platforms Lollipop and after,
     * to ensure consistent dimensions on all platforms.
     *
     * @attr ref android.support.design.R.styleable#MyFloatingActionButton_useCompatPadding
     ...
     *
     * @attr ref android.support.design.R.styleable#MyFloatingActionButton_fabSize
     */
    ...
    private InternalVisibilityChangedListener wrapOnVisibilityChangedListener(
        ...
        return new InternalVisibilityChangedListener() {
            @Override
            public void onShown() {
                listener.onShown(MyFloatingActionButton.this);
            }

            @Override
            public void onHidden() {
                listener.onHidden(MyFloatingActionButton.this);
            }
        };
    }
    ...
    /**
     * Returns the MyFloatingActionButton's background, minus any compatible shadow implementation.
     */
    @NonNull
    ...
    /**
     * Behavior designed for use with {@link MyFloatingActionButton} instances. Its main function
     * is to move {@link MyFloatingActionButton} views so that any displayed {@link Snackbar}s do
     * not cover them.
     */
    public static class Behavior extends CoordinatorLayout.Behavior<MyFloatingActionButton> {
        ...
        /**
         * Sets whether the associated MyFloatingActionButton automatically hides when there is
         * not enough space to be displayed. This works with {@link AppBarLayout}
         * and {@link BottomSheetBehavior}.
         *
         * @attr ref android.support.design.R.styleable#MyFloatingActionButton_Behavior_Layout_behavior_autoHide
        ...
        /**
         * Returns whether the associated MyFloatingActionButton automatically hides when there is
        ...
        @Override
        public boolean onDependentViewChanged(CoordinatorLayout parent, MyFloatingActionButton child,
                                              View dependency) {
        ...
        private boolean shouldUpdateVisibility(View dependency, MyFloatingActionButton child) {
        ...
        private boolean updateFabVisibilityForAppBarLayout(CoordinatorLayout parent,
                                                           AppBarLayout appBarLayout, MyFloatingActionButton child) {
        ...
        @Override
        public boolean onLayoutChild(CoordinatorLayout parent, MyFloatingActionButton child,
                                     int layoutDirection) {
        ...
        public boolean getInsetDodgeRect(@NonNull CoordinatorLayout parent,
                                         @NonNull MyFloatingActionButton child, @NonNull Rect rect) {
         ...
         * our parent's edges.
         */
        private void offsetIfNeeded(CoordinatorLayout parent, MyFloatingActionButton fab) {
    ...
    /**
     * Returns the backward compatible elevation of the MyFloatingActionButton.
     *
     * @return the backward compatible elevation in pixels.
     * @attr ref android.support.design.R.styleable#MyFloatingActionButton_elevation
    ...
    /**
     * Updates the backward compatible elevation of the MyFloatingActionButton.
     *
    ...
    private MyFloatingActionButtonImpl getImpl() {
        if (mImpl == null) {
            mImpl = createImpl();
        }
        return mImpl;
    ...
    private MyFloatingActionButtonImpl createImpl() {
        final int sdk = Build.VERSION.SDK_INT;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            return new MyFloatingActionButtonLollipop(this, new ShadowDelegateImpl(),
                    ViewUtils.DEFAULT_ANIMATOR_CREATOR);
        } else if (sdk >= 14) {
            return new MyFloatingActionButtonIcs(this, new ShadowDelegateImpl(),
                    ViewUtils.DEFAULT_ANIMATOR_CREATOR);
        } else {
            return new MyFloatingActionButtonGingerbread(this, new ShadowDelegateImpl(),
                    ViewUtils.DEFAULT_ANIMATOR_CREATOR);
        }
    }
    ...
    private class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        public void setBackgroundDrawable(Drawable background) {
            MyFloatingActionButton.super.setBackgroundDrawable(background);
        }
