...
@RequiresApi(14)
@TargetApi(14)
public class MyFloatingActionButtonIcs extends MyFloatingActionButtonGingerbread {

    private float mRotation;

    MyFloatingActionButtonIcs(VisibilityAwareImageButton view,
