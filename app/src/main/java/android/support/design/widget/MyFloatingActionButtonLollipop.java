...
@RequiresApi(21)
@TargetApi(21)
public class MyFloatingActionButtonLollipop extends MyFloatingActionButtonIcs {

    private InsetDrawable mInsetDrawable;

    MyFloatingActionButtonLollipop(VisibilityAwareImageButton view,
